...
pygame.display.set_caption("Pathfinding using A*")
...
#heuristic function(how much distance to reach end node)
def h(p1, p2):
    x1, y1 = p1
    x2, y2 = p2
...
def main(win, width):
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            #if the algorithm is started then user won't be able to change anything
            if started:
                continue
